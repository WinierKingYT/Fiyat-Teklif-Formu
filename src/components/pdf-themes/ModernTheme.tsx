...
const ModernTheme = ({
    ...
    const renderEditable = (value, label, onSave, type = 'text', options = [], className = '') => {
        ...
        return (
            ...
            >
                {value || <span className="text-[var(--color-text-muted)] italic">Düzenle</span>}
                <span className="absolute -top-3 -right-3 hidden group-hover:flex h-5 w-5 bg-[var(--color-primary)] text-white rounded-full items-center justify-center shadow-[var(--shadow-sm)]">
