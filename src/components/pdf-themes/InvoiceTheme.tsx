...
const InvoiceTheme: React.FC<PdfThemeProps> = (props) => {
    ...
    const { showSection, itemChunks, vatBreakdown, amountInWords, renderEditable, density: pageDensity, denseImage } = usePdfTheme(props);
    ...
    const invoiceStyles = useMemo(() => `
        ...
        .invoice-theme-container .bottom-section {
            margin-top: auto;
            break-inside: avoid;
            page-break-inside: avoid;
        }

        .invoice-theme-container .signatures-grid {
            margin-top: auto;
            break-inside: avoid;
            page-break-inside: avoid;
        }

        .invoice-theme-container .terms-box {
            margin-top: auto;
            break-inside: avoid;
            page-break-inside: avoid;
        }
