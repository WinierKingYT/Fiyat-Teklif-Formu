...
export default function EmptyState({ icon, title, text, action }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center text-center p-6 space-y-1.5 animate-fadeIn">
      <div className="text-[var(--color-text-muted)] opacity-60 mb-1">
        {icon || ICON_MAP.inbox}
      </div>
