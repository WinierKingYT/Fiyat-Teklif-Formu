...
import { TrendingUp, FileText, DollarSign, Clock, BarChart3, History } from 'lucide-react';
...
const Dashboard = ({ onNavigate }) => {
    ...
    const statCards = [
        { label: t('totalQuotes'), value: stats.totalQuotes, icon: FileText, color: 'primary' },
        { label: t('totalRevenue'), value: fmt(stats.totalRevenue), icon: DollarSign, color: 'accent' },
        { label: t('activeQuotes'), value: stats.pendingQuotes, icon: Clock, color: 'primary' },
        { label: t('thisMonth'), value: fmt(stats.thisMonthRevenue), icon: TrendingUp, color: 'accent' },
    ];
                        ...
                        <div className="card-body">
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <h3 className="text-xl font-bold text-[var(--color-text)] mt-1.5">{item.value}</h3>
                                </div>
                                <div className="w-9 h-9 rounded-[var(--radius)] bg-[var(--color-primary-muted)] flex items-center justify-center flex-shrink-0">
                                    <item.icon size={17} style={{ color: iconColorMap[item.color] }} />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="lg:col-span-2 card">
                    <div className="card-header">
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className="text-sm font-semibold text-[var(--color-text)]">{t('monthlyRevenueChart')}</span>
                        </div>
                    </div>
                    <div className="card-body">
                ...
                <div className="card">
                    <div className="card-header">
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className="text-sm font-semibold text-[var(--color-text)]">{t('recentQuotes')}</span>
                        </div>
                    </div>
                    <div className="card-body">
