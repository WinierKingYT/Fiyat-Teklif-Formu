...
class PerformanceMonitor {
     ...
     */
    async getIndexedDBSize(dbManager) {
        if (!dbManager) {
        ...
        for (const storeName of storeNames) {
            try {
                ...
                sizes[storeName] = { error: error.message, count: 0, sizeBytes: 0 };
            }
        }
     ...
     * @private
     */
    _getAllRecordsNative(db, storeName) {
     ...
     */
    async getPerformanceMetrics(dbManager = null, tabs = []) {
