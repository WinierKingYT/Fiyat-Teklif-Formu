...
describe('ItemsTable', () => {
    ...
    it('updates the row name when the user types', () => {
        render(<Harness />);
    ...
    it('duplicates a row when the duplicate button is clicked', () => {
        render(<Harness initial={[{ id: 'x', name: 'Laptop', description: '', quantity: 1, unit: 'Adet', price: 100, taxRate: 20, discountRate: 0, total: 100 }]} />);
    ...
    it('shows row validation errors after editing an invalid row', () => {
        render(<Harness />);
    ...
    it('adds a new row when Enter is pressed on the last row', () => {
        render(<Harness initial={[{ id: 'x', name: 'Item 1', description: '', quantity: 1, unit: 'Adet', price: 100, taxRate: 20, discountRate: 0, total: 100 }]} />);
    ...
    it('updates VAT rate when selecting a preset from the dropdown', () => {
        render(<Harness initial={[{ id: 'x', name: 'Item 1', description: '', quantity: 1, unit: 'Adet', price: 100, taxRate: 20, discountRate: 0, total: 100 }]} />);
